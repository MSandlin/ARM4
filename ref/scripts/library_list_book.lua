...
function rebuildCategories()
	...
	for k, v in ipairs(getWindows()) do
		local sCategory = DB.getValue(v.getDatabaseNode(), "categoryname", "");
...
function onSortCompare(w1, w2)
	...
	if w1.getClass() == "library_booklistentry" then
		sCategory1 = DB.getValue(w1.getDatabaseNode(), "categoryname", "");
		bIsCategory1 = false;
	...
	if w2.getClass() == "library_booklistentry" then
		sCategory2 = DB.getValue(w2.getDatabaseNode(), "categoryname", "");
		bIsCategory2 = false;
