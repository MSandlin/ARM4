...
function toggleForceActive()
	...
	if forceactive then
			...
			spellIbonusTag.setVisible(true);
			spellIbonus.setVisible(true);
			initTag.setVisible(true);
			init.setVisible(true);
			ActTag.setVisible(true);
			CastAct.setVisible(true);
			spellxp.setVisible(true);
			
			spellframe.setVisible(true);
			spellframesmall.setVisible(false);
			...
			spellIbonusTag.setVisible(false);
			spellIbonus.setVisible(false);
			initTag.setVisible(false);
			init.setVisible(false);
			ActTag.setVisible(false);
			CastAct.setVisible(false);
			spellxp.setVisible(false);
			spellframe.setVisible(false);
			spellframesmall.setVisible(true);
